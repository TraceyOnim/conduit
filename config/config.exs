...
config :conduit, ConduitWeb.Endpoint,
  ...
  live_view: [signing_salt: "qo7ZPiwm"]
...
config :conduit,Conduit.ConduitApplication,
  event_store: [
...
config :conduit, Conduit.EventStore, serializer: Commanded.Serialization.JsonSerializer
